    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <form class="text-left clearfix" action="components/auth.php" method="post">
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-main btn-medium btn-round text-center" >Inicia sesión</button>
            </div>
          </form>
          <p class="mt-20">No tienes cuenta?<a href="signin.php"> Crea una nueva</a></p>
        </div>
      </div>
    </div>
  </div>
