    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="list-inline dashboard-menu text-center">
		  <?php
		  	if(isset($_SESSION['nombre_usuario'])){
				...
				if($_SESSION['nombre_usuario'] == 'Administrador'){
					echo '
					<li><a href="order.php">Historial</a></li>
          ...
          <li><a class="active"  href="profile-details.php">Detalles</a></li>
        </ul>
              ...
              <ul class="user-profile-list">
				...
				if ($row_cnt === 1) {
					while($row = mysqli_fetch_array($result)) {
						...
						$perfil ='
						<li><span>Nombre:</span>'.$row['nombre_usuario'].'</li>
						<li><span>País:</span>'.$row['pais_usuario'].'</li>
						<li><span>Email:</span>'.$row['correo_usuario'].'</li>
						<li><span>Dirección:</span>'.$row['direccion_usuario'].'</li>
						<li><span>Fecha de Nacimiento:</span>'.$row['nacimiento_usuario'].'</li>
					';
					echo $perfil;
					...
					$perfil = '
						<li><span>Errpr:</span>Se encontró un error</li>
					';
					echo $perfil;
