    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <form class="text-left clearfix" action="components/agregarProd.php" method="post">
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-main btn-medium btn-round text-center" >Agregar Producto</button>
            </div>
          </form>
        </div>
      </div>
